...
D_ATTRIBUTE_FORMAT(2, 3) void cwarning(const Loc& loc, const char *format, ...);
D_ATTRIBUTE_FORMAT(2, 3) void cwarningSupplemental(const Loc& loc, const char *format, ...);
D_ATTRIBUTE_FORMAT(2, 3) void cdeprecation(const Loc& loc, const char *format, ...);
D_ATTRIBUTE_FORMAT(2, 3) void cdeprecationSupplemental(const Loc& loc, const char *format, ...);
D_ATTRIBUTE_FORMAT(2, 3) void cerror(const Loc& loc, const char *format, ...);
D_ATTRIBUTE_FORMAT(4, 5) void cerror(const char *filename, unsigned linnum, unsigned charnum, const char *format, ...);
D_ATTRIBUTE_FORMAT(2, 3) void cerrorSupplemental(const Loc& loc, const char *format, ...);
...
D_ATTRIBUTE_FORMAT(1, 2) void cmessage(const char *format, ...);
D_ATTRIBUTE_FORMAT(2, 3) void cmessage(const Loc& loc, const char *format, ...);
